...
HAL東京でゲームプログラマーを学んでおり、Unity、DirectX11、Unreal Engineを使ったゲーム開発を勉強しています。  
主に **3Dアクションゲームやシューティングゲーム** の制作を行っています。

- 🔭 現在開発中: **Unreal Engine プロジェクト（名前未定 / 3D シューティング）**
- 🌱 現在学習中: **C++上級、HLSLシェーダプログラミング**  
- 👯 コラボしたい: **ゲームエンジンや3Dゲームプロジェクト**  
- 💬 聞いてほしいこと: **ゲーム開発、3Dプログラミング、シェーダ表現**  
